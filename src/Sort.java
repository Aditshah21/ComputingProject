...
public final class Sort
{
    ...
    public static void main( String [ ] args )
    {
        ...
        long quick_avg_time = 0;
        	...
        	{
        		a[j] = rand.nextLong();
        		//System.out.println("random: "+a[i]);
        	}

        	long startTime = System.nanoTime( ); // Start time in nano seconds

        	Sort.quicksort(a);
        	checkSort(a);

        	long endTime = System.nanoTime( );  // end time in nano seconds

        	//////////  Time calculation   /////////
        	total_time = endTime - startTime; // total average time calculated during sorting
        	quick_avg_time = quick_avg_time + (total_time); // storing all times in one variable
